...
} from "@/gary/contracts/design";
import {
  DEFAULT_OPTION,
  EMITTER_SIZING,
  OPTIONS,
  TECHNICAL_DEFAULTS,
} from "@/gary/config/decisions";
import {
  correctionFactor,
  outputAtConditionsW,
  sizeRoomEmitter,
} from "@/gary/lib/engine/emitter";
import { selectHeatPump, type HeatPumpModel } from "@/gary/lib/engine/heatpump";
import { selectRadiator, type RadiatorModel } from "@/gary/lib/engine/radiator";
import { modelAt } from "@/gary/lib/engine/catalog/vaillantAroThermPro7kw";
import { STELRAD_COMPACT_CATALOGUE } from "@/gary/lib/engine/catalog/stelradCompact";
import {
