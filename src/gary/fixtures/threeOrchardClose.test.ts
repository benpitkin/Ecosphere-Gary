...
import { correctionFactor } from "@/gary/lib/engine/emitter";
import { matchHeatPump } from "@/gary/lib/engine/heatpump";
import { modelAt, capacityKw } from "@/gary/lib/engine/catalog/vaillantAroThermPro7kw";
import {
  threeOrchardCloseSurvey,
  REPORTED_TYPE21_P_600H,
  EXPECTED_HEAT_PUMP,
} from "@/gary/fixtures/threeOrchardClose";
